...
<script lang="ts" setup>
    ...
    const hobbies: Hobby[] = [
        ...
        },
        {
            activity: "Watching",
            name: 'Horror Movies',
            favorites: 'Child\'s Play, Friday the 13th, Halloween, Night of the Living Dead, Nightmare on Elm Street, Return of the Living Dead'
        },
        {
            activity: "Watching",
            name: 'Sports',
            favorites: 'Baseball, Basketball, Football, Wrestling'
        },
    ]
</script>